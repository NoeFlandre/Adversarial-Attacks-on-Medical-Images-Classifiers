#!/usr/bin/env python3
"""
Main entry point for the Breast Tumor Classification using TinyResNet.
...
def main():
    parser = argparse.ArgumentParser(
        description="Breast Tumor Classification - TinyResNet with Adversarial Attacks",
    ...
    # Training command
    train_parser = subparsers.add_parser('train', help='Train the TinyResNet model')
    train_parser.add_argument('--data_path', type=str, default='data/', help='Path to the dataset')
    train_parser.add_argument('--epochs', type=int, default=10, help='Number of training epochs')
    train_parser.add_argument('--batch_size', type=int, default=64, help='Batch size for training and evaluation')
    ...
    train_parser.add_argument('--num_blocks', type=int, default=1, help='Number of residual blocks per layer')
    
    # Adversarial training command
    adv_train_parser = subparsers.add_parser('adv_train', help='Train the TinyResNet model with adversarial training')
    adv_train_parser.add_argument('--data_path', type=str, default='data/', help='Path to the dataset')
    adv_train_parser.add_argument('--epochs', type=int, default=10, help='Number of training epochs')
    adv_train_parser.add_argument('--batch_size', type=int, default=64, help='Batch size for training and evaluation')
    ...
    adv_train_parser.add_argument('--num_blocks', type=int, default=1, help='Number of residual blocks per layer')
    ...
    attack_parser.add_argument('--num_blocks', type=int, default=1, help='Number of residual blocks per layer')
