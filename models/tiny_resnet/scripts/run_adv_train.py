...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train TinyResNet model with adversarial training')
    ...
    logger.info("Starting TinyResNet classifier with adversarial training")
    ...
    model_path = os.path.join(model_dir, f'tiny_resnet_adversarial_eps{args.epsilon}_mix{args.mix_ratio}_{timestamp}.pth')
    ...
    summary = {
        'model_type': 'tiny_resnet_adversarial',
        'timestamp': timestamp,
