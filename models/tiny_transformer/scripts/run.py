...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train and evaluate Tiny Transformer model for breast histopathology')
    ...
    logger.info("Starting Tiny Transformer classifier training and evaluation")
    ...
    model_path = os.path.join(model_dir, f'tiny_transformer_model_{timestamp}.pth')
    torch.save({
