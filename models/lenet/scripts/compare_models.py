...
def load_model(checkpoint_path, device):
    ...
    # Check if state_dict is inside the checkpoint file
...
def compare_models(standard_model_path, adv_model_path, data_dir, 
    ...
    logger = setup_logger(name=f'lenet_comparison_{timestamp}', log_type='model_comparison')
    ...
    # Load models
    standard_model, is_std_adv, std_adv_params = load_model(standard_model_path, device)
    adv_model, is_adv, adv_params = load_model(adv_model_path, device)
