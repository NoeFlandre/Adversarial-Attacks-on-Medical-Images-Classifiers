...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train MLP model with adversarial training')
    ...
    logger.info("Starting MLP classifier with adversarial training")
    ...
    model_path = os.path.join(model_dir, f'mlp_adversarial_eps{args.epsilon}_mix{args.mix_ratio}_{timestamp}.pth')
