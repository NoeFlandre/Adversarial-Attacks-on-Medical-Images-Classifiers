...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train and evaluate MLP model for breast histopathology')
    ...
    logger.info("Starting MLP classifier training and evaluation")
    ...
    model_path = os.path.join(model_dir, f'mlp_model_{timestamp}.pth')
    torch.save({
