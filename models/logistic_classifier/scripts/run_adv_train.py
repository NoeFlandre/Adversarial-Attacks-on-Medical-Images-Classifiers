...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train logistic regression model with adversarial training')
    ...
    logger.info("Starting Logistic Regression classifier with adversarial training")
    ...
    model_path = os.path.join(model_dir, f'logistic_regression_adversarial_eps{args.epsilon}_mix{args.mix_ratio}_{timestamp}.pth')
    ...
    summary = {
        'model_type': 'logistic_regression_adversarial',
        'timestamp': timestamp,
